(function () {
	...
	function scrambleWordGame() {
		var correctWords = [],
			...
			counter = 0,
			score = 0,
			fiveMins = 60 * 2, // 60 seconds multiply 2
			timer = doc('.timer'),
			callTimer,
			html;
		...
		function pushWord() {
			...
			correctWords[0] = wordWrapper.wordArr[generateUniqueNumber(0, 4)];
			correctWords[1] = wordWrapper.wordArr[generateUniqueNumber(5, 9)];
			correctWords[2] = wordWrapper.wordArr[generateUniqueNumber(10, 14)];
			correctWords[3] = wordWrapper.wordArr[generateUniqueNumber(15, 19)];
			correctWords[4] = wordWrapper.wordArr[generateUniqueNumber(20, 24)];
			correctWords[5] = wordWrapper.wordArr[generateUniqueNumber(25, 29)];
			correctWords[6] = wordWrapper.wordArr[generateUniqueNumber(30,34 )];
			correctWords[7] = wordWrapper.wordArr[generateUniqueNumber(35, 39)];
			correctWords[8] = wordWrapper.wordArr[generateUniqueNumber(40, 44)];
			correctWords[9] = wordWrapper.wordArr[generateUniqueNumber(45, 49)];
		...
		function gameOver() {
			...
			if (score === 0) {
				resultTitle.textContent = 'Too poor';
				...
				resultTitle.textContent = 'Excellent, all the words are safe.';
		...
		function checkUserInput(elem) {
			if (inputBox.value.toLowerCase() === elem[0]) {
				...
				$successMsg.text('congrats!! correct');
